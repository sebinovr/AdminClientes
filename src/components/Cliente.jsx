    ...
    return (
        <tr className="border-b">
            ...
            <td className="p-6 space-y-2">
               ...
               <p className="text-2xl text-gray-600"> <span className="text-gray-800 uppercase font-bold">Telefono:</span> {telefono}</p>
            </td>
                ...
                <Form
                    ...
                    onSubmit={(e)=> {
                        if(!confirm('¿Deseas eliminar este registro?')){
                            e.preventDefault()  //Evita que se ejecute el accion de redireccionar a pag principal  
                        }
                    }}
                >
                    <button
